...
```shell
curl -u "username:token" -X GET 'http://localhost:9000/api/import/subscribers'
```
...
```shell
curl -u "username:token" -X GET 'http://localhost:9000/api/import/subscribers/logs'
```
...
```shell
curl -u "username:token" -X POST 'http://localhost:9000/api/import/subscribers' \
...
```shell
curl -u "username:token" -X DELETE 'http://localhost:9000/api/import/subscribers'
```
