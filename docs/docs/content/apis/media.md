...
```shell
curl -u "username:token" -X GET 'http://localhost:9000/api/media' \
...
```shell
curl -u "username:token" -X GET 'http://localhost:9000/api/media/7'
```
...
```shell
curl -u "username:token" -X POST 'http://localhost:9000/api/media' \
...
```shell
curl -u "username:token" -X DELETE 'http://localhost:9000/api/media/1'
```
