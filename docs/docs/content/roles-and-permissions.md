...
| contacts    | contacts:get            | Get individual contact details                                                                                                                                                                                                       |
|             | contacts:get_all        | Get all contacts across workspace                                                                                                                                                                                                    |
|             | contacts:manage         | Add, update, delete contacts and sequence memberships                                                                                                                                                                               |
...
| sequences   | sequences:get           | Get and view automated outreach sequences                                                                                                                                                                                            |
|             | sequences:get_all       | Get and view sequence details across workspace                                                                                                                                                                                       |
|             | sequences:get_analytics | Access sequence step and engagement performance metrics                                                                                                                                                                              |
|             | sequences:manage        | Create, update, and delete sequence steps                                                                                                                                                                                            |
|             | sequences:manage_all    | Manage sequence rules and configurations                                                                                                                                                                                             |
|             | sequences:send          | Activate, pause, resume, and test sequence steps                                                                                                                                                                                    |
| schedules   | schedules:get           | View daily sending time windows and schedules                                                                                                                                                                                        |
|             | schedules:manage        | Create, update, and delete sending schedules                                                                                                                                                                                         |
| whatsapp    | whatsapp:get            | View active WhatsApp / WAHA sessions and delivery status                                                                                                                                                                             |
|             | whatsapp:manage         | Connect, configure, and manage WhatsApp messenger accounts                                                                                                                                                                           |
| emails      | emails:get              | View email account settings and SMTP server profiles                                                                                                                                                                                 |
|             | emails:manage           | Configure, test, and manage email sender profiles                                                                                                                                                                                   |
