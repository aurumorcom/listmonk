...
func (c *Core) CreateTemplate(name, typ, subject string, body []byte, bodySource null.String, parentTemplateID null.Int) (models.Template, error) {
	var newID int
	if err := c.q.CreateTemplate.Get(&newID, name, typ, subject, body, bodySource, parentTemplateID); err != nil {
		return models.Template{}, echo.NewHTTPError(http.StatusInternalServerError,
...
func (c *Core) UpdateTemplate(id int, name, subject string, body []byte, bodySource null.String, parentTemplateID null.Int) (models.Template, error) {
	res, err := c.q.UpdateTemplate.Exec(id, name, subject, body, bodySource, parentTemplateID)
	if err != nil {
		return models.Template{}, echo.NewHTTPError(http.StatusInternalServerError,
